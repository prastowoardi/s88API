...
const ENV_CONFIGS = {
  ...
  PayBO_ezyplus:       { file: ".paybo_ezyplus",     label: "Ezyplus"              },
  PayBO_wandpay:       { file: ".paybo_wandpay",     label: "Wandpay"              },
  PayBO_swftx:         { file: ".paybo_swftx",       label: "Swftx"                },
  PayBO_rangoon:       { file: ".paybo_rangoon",     label: "Rangoon"              },
  PayBO_bajix:         { file: ".paybo_bajix",       label: "Bajix"                },
  PayBO_dreampay:      { file: ".paybo_dreampay",    label: "Dreampay"             },
  PayBO_erfolgpay:     { file: ".paybo_erfolgpay",   label: "Erfolgpay"            },
  PayBO_commspay:      { file: ".paybo_commspay",    label: "Commspay"             },
  PayBO_demo:          { file: ".paybo_demo",        label: "PayBO Demo"           },
  PayBO_apollo:        { file: ".paybo_apollo",      label: "Apollo"               },
  PayBO_apollo_INR:    { file: ".paybo_apollo_inr",  label: "Apollo INR"           },
  PayBO_xcpay:         { file: ".paybo_xcpay",       label: "XCPay"                },
  PayBO_tiger:         { file: ".paybo_tiger",       label: "Tiger2378"            },
  PayBO_next8:         { file: ".paybo_next8",       label: "Next8"                },
  PayBO_cosmospay:     { file: ".paybo_cosmospay",   label: "Cosmospay"            },

...
import {
    ...
    SECRET_KEY_INR, SECRET_KEY_VND, SECRET_KEY_BDT, SECRET_KEY_BRL,
    DEPOSIT_METHOD_INR, DEPOSIT_METHOD_VND, DEPOSIT_METHOD_BDT, DEPOSIT_METHOD_BRL,
    MERCHANT_CODE_INR, MERCHANT_CODE_VND, MERCHANT_CODE_BDT, MERCHANT_CODE_BRL,
    MERCHANT_API_KEY_INR, MERCHANT_API_KEY_VND, MERCHANT_API_KEY_BDT, MERCHANT_API_KEY_BRL
...
async function depositV2() {
    ...
    const currency = readlineSync.question("Masukkan Currency (INR/VND/BDT/BRL): ").toUpperCase();
    if (!["INR", "VND", "BDT", "BRL"].includes(currency)) {

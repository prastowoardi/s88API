...
const SUPPORTED_CURRENCIES = ["INR", "VND", "BDT", "MMK", "KRW", "THB", "KHR", "MYR", "PHP", "JPY", "MYR", "NPR", "PKR", "PHP", "USDT"];
...
class DepositService {
    ...
    async buildPayload(config, tx, user) {
        ...
        if (tx.currency === "NPR") {
            ...
            payload.bank_code = "FONEPAY";
            payload.depositor_bank_code = depositorBank;
